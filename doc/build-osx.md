...
* Database errors have been seen in builds on High Sierra. One solution is to build Berkeley DB from source.
        ...
        Then configure Altbet with this build of BerkeleyDB,
...
The use homebrew to install a number of unix programs and libraries needed to build the Altbet wallet:
...
You have the choice to build the GUI Altbet wallet as a Mac OSX app, described in “How to build the Altbet-Qt App”. If, for whatever reason, you prefer to use the command line tools, continue with “Command line tools”.

### How to build the Altbet-Qt App:

After make is finished, you can create an App bundle inside a disk image with:

```make deploy```

Once this is done, you’ll find Altbet-Qt.dmg inside your Altbet folder. Open and install the wallet like any typical Mac app.
...
~/Downloads/Altbet/src/qt/altbet-qt