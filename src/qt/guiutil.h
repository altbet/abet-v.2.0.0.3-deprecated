...
/** Utility functions used by the Altbet Qt UI.
 */
namespace GUIUtil
{
...
// Render Altbet addresses in monospace font
...
// Parse "altbet:" URI into recipient object, return true on successful parsing
