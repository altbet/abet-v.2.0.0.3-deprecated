 ...
 */
    ...
    typeWidget->addItem(tr("Received Abet from zAbet"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zAbet"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zAbet));
