                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Altbet Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Altbet address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and altbet: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zABET"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Altbet Core"), this);
    aboutAction->setStatusTip(tr("Show information about Altbet Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Altbet"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Altbet addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Altbet addresses"));
    ...
    openAction->setStatusTip(tr("Open a Altbet: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Altbet Core help message to get a list with possible Altbet command-line options"));
...
void BitcoinGUI::createToolBars()
{
    if (walletFrame) {
        ...
        header->setPixmap(QPixmap(":/images/altbet_logo_horizontal"));
...
{   
    ...
    QNetworkReply *reply = manager.get(QNetworkRequest(QUrl(QString("https://wallet.altbet.io/ads/%1.png").arg(unixtime))));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Altbet Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Altbet network", "", count));
}
...
{
    QString strTitle = tr("Altbet Core"); // default title
