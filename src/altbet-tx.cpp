...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Altbet Core altbet-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  altbet-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded altbet transaction") + "\n" +
                               "  altbet-tx [options] -create [commands]   " + _("Create hex-encoded altbet transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded altbet transaction
