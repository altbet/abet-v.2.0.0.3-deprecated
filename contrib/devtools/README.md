...
Altbet-Project/Altbet repository.
...
Setup
---------
Configuring the github-merge tool for the Altbet repository is done in the following way:

    git config githubmerge.repository Altbet-Project/Altbet
...
A script to optimize png files in the Altbet
