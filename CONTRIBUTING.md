Contributing to Altbet Core
============================

The Altbet Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Altbet Core project, and is not to be
confused with overall Altbet Network Protocol consensus changes.

Whether a pull request is merged into Altbet Core rests with the project merge
...
Patches that change Altbet consensus rules are considerably more involved than
...
Where a patch set proposes to change the Altbet consensus, it must have been
...
The project leader is the release manager for each Altbet Core release.
